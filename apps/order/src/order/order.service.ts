...
// import { Payment } from './infrastructure/mongoose/entity/payment.entity';
// import { Model } from 'mongoose';
// import { InjectModel } from '@nestjs/mongoose';
// import { Order, OrderStatus } from './infrastructure/mongoose/entity/order.entity';
...
//     // 4. 금액 검증하기 - total이 맞는지(프론트에서 보내준 데이터)
